...
CMD ["sh", "-c", "mlflow ui --host 0.0.0.0 --port 8080 & gunicorn --timeout 3600 --workers 2 --worker-class uvicorn.workers.UvicornWorker app.main:app --bind 0.0.0.0:8000 --log-level info --access-logfile - --error-logfile -"]

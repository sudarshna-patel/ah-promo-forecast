...
def split_data(df_prep_clean):
    ...
    train_df, test_df = train_test_split(
        total_df=df_to_split, tr_split_date=train_split_date
    )
    ...
    train_df_lag = add_lagged_feature_to_df(
        input_df=train_df, lag_iterator=range_of_lags, feature=feature_to_lag
    )
    test_df_lag = add_lagged_feature_to_df(
        input_df=test_df_filtered, lag_iterator=range_of_lags, feature=feature_to_lag
    )
